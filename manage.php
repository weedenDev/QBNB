...
<html>
	...
	<div class="container">
		<div id='updateProfile' class="row text-center">
			...
			<div class="col-md-3">
				<form name='viewList' id='urhouseBtn' action='viewComment.php' method='post'>
					<label>View comments of your listings</label>
					<input type="submit" id="urListingBtn" class="btn btn-success btn-lg" value="View Comments"/>
				</form>
			</div>
		</div>
	</div>
