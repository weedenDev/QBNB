		...
		<?php
			if(isset($_SESSION['id'])){
			   // include database connection
				...
				$currentID = $_SESSION['id'];
				// SELECT query
			        $query = "SELECT * FROM QBnB_Service_Member WHERE type > '0'";
			        // prepare query for execution
			        $stmt = $con->prepare($query);
			        // bind the parameters. This is the best way to prevent SQL injection hacks.
			        //$stmt->bind_Param("s", $_SESSION['id']);
				...
				<div class="collapse navbar-collapse navbar-menu-collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						?>
							...
							<li><a href='index.php?logout=1'>Log Out</a>
					</ul>
		...
		<div class="container">
			<div id='updateProfile' class="row">
				<div class="col-md-12">
					...
					<?php
						echo "<tr class='heading'>"."<td>member_ID</td>"."<td>First Name</td>"."<td>Last Name</td>"."<td>house_ID</td>"."<td>email</td>"."<td>Phone Number</td>"."<td>Year</td>"."<td>Faculty</td>"."<td>Type</td>"."<td>Remove</td>"."</tr>";
						while($myrow = $result->fetch_assoc()) {
							echo "<form name='deleteMember' id='deleteMember' action='adminRemoveAdmin.php' method='post'><tr>"."<td>".$myrow['member_ID']."</td>"."<td>".$myrow['fName']."</td>"."<td>".$myrow['lName']."</td>"."<td>".$myrow['house_ID']."</td>"."<td>".$myrow['email']."</td>"."<td>".$myrow['phone_number']."</td>"."<td>".$myrow['year']."</td>"."<td>".$myrow['faculty']."</td>"."<td>".$myrow['type']."</td>"."<td><input type='submit' id='addRMBtn' name='addRMBtn' value='Revoke Admin'/></td><input class='dontshow' type='text' id='memID' name='memID' value='".$myrow['member_ID']."'/></form>"."</tr>"."<br>";
						}
					?>
					</table>
					<div class="col-md-4">
